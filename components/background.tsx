...
export function AnimatedBackgroundFirst() {
    ...
    return (
        <motion.div
            className="fixed top-0 left-0 w-full h-screen bg-mountain-1"
            style={{ clipPath }}
        />
    );
}
...
export function AnimatedBackgroundSecond() {
    ...
    return (
        <motion.div
            className="fixed top-0 left-0 w-full h-screen bg-mountain-2"
            style={{ clipPath }}
        />
    );
}
...
export function AnimatedBackgroundThird() {
    ...
    return (
        <motion.div
            className="fixed top-0 left-0 w-full h-screen bg-mountain-3"
            style={{ clipPath }}
        />
    );
}
...
export function AnimatedBackgroundFourth() {
    ...
    return (
        <motion.div
            className="fixed top-0 left-0 w-full h-screen bg-mountain-4"
            style={{ clipPath }}
        />
    );
}
...
export function AnimatedBackgroundFifth() {
    ...
    return (
        <motion.div
            className="fixed top-0 left-0 w-full h-screen bg-mountain-5"
            style={{ clipPath }}
        />
    );
}
...
export function AnimatedBackgroundSixth() {
    ...
    return (
        <motion.div
            className="fixed top-0 left-0 w-full h-screen bg-mountain-6"
            style={{ clipPath }}
        />
    );
}